...
public class IncidentGraphRunner {
    ...
    public IncidentGraphRunner(AlertParserNode alertParserNode, PlannerNode plannerNode,
                               ToolExecutorNode toolExecutorNode, EvidenceAnalyzerNode evidenceAnalyzerNode,
    ...
    public IncidentReport run(String caseId) {
